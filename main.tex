...
\begin{document}
\frontmatter
\title{Assembling and programming an IoT scale sensor}
...
\input{chapters/2_intro}

\chapter{Background}
\input{chapters/3_background}

\chapter{Requirements}
\input{chapters/3.5_requirements.tex}

\chapter{Design \& Implementation}
\input{chapters/4_methodology}

% \chapter{Related Work}
% \input{chapters/4.5_related_work.tex}

\chapter{Results}
\input{chapters/5_results_discussion}

\chapter{Conclusions}
\input{chapters/6_conclusions_future_work}
